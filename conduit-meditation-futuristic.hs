...
sumSink2 :: MonadResource m => Sink Int m Int
sumSink2 = sinkState
    0 -- initial value
...
fibs :: MonadResource m => Source m Int
fibs = sourceState
    (0, 1) -- initial state
...
textify :: MonadResource m => Conduit Int m Text
...
textify2 :: MonadResource m => Conduit Int m Text
...
-- well for practice.
unlines' :: MonadResource m => Conduit Text m Text
...
someIntLines :: (MonadThrow m, MonadResource m) -- encoding can throw an exception
             => Int
